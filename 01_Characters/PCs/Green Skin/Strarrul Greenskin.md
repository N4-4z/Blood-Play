...
| **Short bow**          |                                                                                        |             | 50 ft      |          |            |
| **Fist**               |                                                                                        |             |            |          |            |
| **Great sword**        | Need to take a break after using this attack twice. Can chop off body parts of enemies |             | +2Foot     |          |            |
| **Great shield**       | Need to take a break after using this twice.                                           |             |            |          |            |
| **The Chrisman Blade** | Upon hitting CHP X is increased by 1                                                   |             |            |          |            |
| **Golden Temptation**  | Can tempt enemies to attack. And can also scare.                                       |             |            |          |            |
...
| :-: | :------------------ | :----------: | :-: | :--------------------------------------------------------------------------------- | :---- | :------------- | :---------- | :--------- |
|  -  | **Minor Heal**      |   Instant    |  1  | Can heal a creatures WHP                                                           | Touch | none           |             |            |
...
|  -  | **Major heal**      |    1 turn    |  2  | Can heal a creatures WHP and CHP by                                                | Touch | none           |             |            |
|  -  | **Enchant**         |    1 turn    | 20  | Can enchant any weapon for a single time increasing its die count by 2.ex (X+2)dy. | Touch | 5turns/10min   |             |            |
...
|  -  | **Heal**            |   1 Action   | 150 | The most powerful single target healing spell... Restores all WHP & CHP.           | Touch | Instant        |             |            |
